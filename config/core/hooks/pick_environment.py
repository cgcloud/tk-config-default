    ...
    def execute(self, context, **kwargs):
        ...
        if context.entity and context.step:
            ...
            if context.entity["type"] == "Shot":
                return "shot_step"
            if context.entity["type"] == "Asset":
                if context.step == "Model":
                    return "asset_step_model"
                elif context.step == "Rig":
                    return "asset_step_rig"
                elif context.step == "Shading":
                    return "asset_step_shading" 
                elif context.step == "CycleAnim":
                    return "asset_step"
                elif context.step == "AssetLight":
                    return "asset_step"
                else:
                    return "asset_step"
